...
function Index() {
  ...
  return (
    <div className='flex flex-col justify-center items-center py-8'>
     ...
     <div className='flex flex-row justify-end mt-2 w-[100%]'><button onClick={handle("Pro/Cranker")} className='bg-purple-500 text-white font-mono px-3 py-2 rounded-xl'>Run Cranker</button></div>
     </div>
     ...
     <div className='flex flex-row justify-end mt-2 w-[100%]'><button className='bg-purple-500 text-white font-mono px-3 py-2 rounded-xl'>Coming soon</button></div>
     </div>
     </div>
    </div>
  )
